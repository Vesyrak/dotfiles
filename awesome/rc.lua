...
tags = {
        names  = { "Smile,", "Just", "To", "Oppose", "Those", "Who", "Defy", "You"},
        layout = { layouts[6], layouts[6], layouts[6], layouts[6],layouts[6],layouts[6],layouts[6],layouts[6]}
}
...
fsusage=lain.widgets.fs({
   partition= "/",
   settings = function()
        widget:set_markup(fs_now.size_gb .."GB") --TODO
    end
})
...
for s = 1, screen.count() do
    ...
    middle_layout:add(mpdwidget)
    -- Widgets that are aligned to the right
    local right_layout = wibox.layout.fixed.horizontal()
    right_layout:add(spacebox)
    right_layout:add(fsusage)
    right_layout:add(spacebox)
